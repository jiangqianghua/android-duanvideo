...
public class NearbyPageFragment extends BaseFragment {
    ...
    class WorksListAdapter extends RecyclerView.Adapter{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = ((Activity)mContext).getLayoutInflater().inflate(R.layout.item_nearby,null);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(holder instanceof ItemViewHolder){
                ...
                itemViewHolder.mDistanceTextView.setText(worksItemModule.getDistance());
        ...
        public class ItemViewHolder extends RecyclerView.ViewHolder{
            ...
            public ItemViewHolder(View view)
            {
                ...
                mAvaterImageView = ViewUtils.bindViewId(view,R.id.nearby_avatar_iv);
                mDetailTextView = ViewUtils.bindViewId(view,R.id.detail_tv);
                mUserNameTextView = ViewUtils.bindViewId(view,R.id.username_tv);
                mDistanceTextView = ViewUtils.bindViewId(view,R.id.distance_tv);
            }
        }
    }

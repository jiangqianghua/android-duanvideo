 ...
 */
public class JVideoView_error extends RelativeLayout implements SurfaceHolder.Callback {
    ...
    public JVideoView_error(Context context) {
        super(context);
        init(context);
    }

    public JVideoView_error(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public JVideoView_error(Context context, AttributeSet attrs, int defStyleAttr) {

...
public class RecodBtnView extends View {


    private static final String TAG = RecodBtnView.class.getSimpleName();
    ...
    public RecodBtnView(Context context) {
        this(context, null);
    }

    public RecodBtnView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecodBtnView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    final ValueAnimator valueAnimator = ValueAnimator.ofFloat(1.0F, -1.0F);

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {

        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RecodBtnView, defStyleAttr, 0);
        mBtnBackground = attributes.getColor(R.styleable.RecodBtnView_tb_color, ContextCompat.getColor(context, R.color.colorRed));
        mTextColor = attributes.getColor(R.styleable.RecodBtnView_tb_text_color, ContextCompat.getColor(context, android.R.color.white));
        mText = attributes.getString(R.styleable.RecodBtnView_tb_text);
        mAnimPadding = attributes.getDimension(R.styleable.RecodBtnView_tb_anim_padding, dip2px(getContext(), 10));
        attributes.recycle();
